...
def config_parser(cmd=None):
    ...
    # learning rate
    parser.add_argument(
        "--lr_init", type=float, default=0.02, help="learning rate"
    )
    parser.add_argument(
        "--lr_basis", type=float, default=1e-3, help="learning rate"
    )
    parser.add_argument(
        "--lr_decay_iters",
        type=int,
    ...
    parser.add_argument(
        "--L1_weight_rest", type=float, default=0, help="loss weight"
    )
    parser.add_argument(
        "--Ortho_weight", type=float, default=0.0, help="loss weight"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--pos_pe", type=int, default=6, help="number of pe for pos"
    )
    parser.add_argument(
        "--view_pe", type=int, default=6, help="number of pe for view"
    )
    parser.add_argument(
